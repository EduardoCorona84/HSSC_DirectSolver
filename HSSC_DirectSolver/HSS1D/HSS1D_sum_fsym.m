function C_HSS = HSS1D_sum_fsym(A_HSS,B_HSS,acc)
%
...
%
%    DESCRIPTION:
%        This function adds two full-symmetric HSS matrices A and B that share source and target
%        trees.
%
%    INPUT:
