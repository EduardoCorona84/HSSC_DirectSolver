function [HSSinv,FTinv] = HSS1D_invert_nsym(K_HSS,acc)
%
...
%            children's interactions. It can also be considered Dinv for the top box. 
%
...
for ibox = nboxes:(-1):2
  ...
  E_VEC{ibox}    = E;
  % HSSinv factors
  HSSinv{BOX.Linv,ibox}      = Finv*L*E;
  HSSinv{BOX.Rinv,ibox}      = E*R*Finv;
