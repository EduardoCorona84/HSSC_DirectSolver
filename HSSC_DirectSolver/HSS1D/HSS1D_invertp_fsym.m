function [HSSinv,FTinv,FT] = HSS1D_invertp_fsym(K_HSS,acc)
%
...
for ibox = nboxes:(-1):2
  ...
  HSSinv{Rinv,ibox}      = EI\FiL.'; %(EI\L.')/F;
  HSSinv{Dinv,ibox}      = F\(eye(n) - L*HSSinv{Rinv,ibox}); %Finv - FiL*HSSinv{Rinv,ibox};
