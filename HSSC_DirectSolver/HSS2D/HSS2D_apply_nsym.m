function Y = HSS2D_apply_nsym(INFO_TREE,A_HSS,X,params)
%
    ...
    for i = 1:INFO_TREE.numlev(lev+1)
        ...
        if INFO_TREE.BOX(Nbox).child(1) == 0
            ...
            if lev>lev_HSS    
                ...
                %lam = [ HSS1D_apply_nsym(B12,phi_up{C2}) ; HSS1D_apply_nsym(B21,phi_up{C1}) ]; 
                lam = HSS1D_apply_nsym(B12,[phi_up{C1} ; phi_up{C2}]);
            end
        end
